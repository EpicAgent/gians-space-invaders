...
@Component
public class GameObjectFactoryForTesting implements Factory {
    ...
    @Autowired
    @Lazy
    public GameObjectFactoryForTesting(Spaceship spaceship, Weapon weapon){
...
/*
    ...
    public GameObjectFactoryForTesting(ApplicationContext context, Supplier<List<GameObject>> supplier) {
        this.context = context;
        this.supplier = supplier;
    }
    public static Factory createOneAlienAndOneSpaceship(ApplicationContext context) {
        return new GameObjectFactoryForTesting(context, () -> {
            List<GameObject> gameObjects = new ArrayList<>();
