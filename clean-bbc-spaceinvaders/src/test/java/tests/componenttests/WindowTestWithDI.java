...
import common.AppParameterResolver;
...
@ExtendWith(WindowTestWithDI.class)
@ExtendWith(AppParameterResolver.class)
class WindowTestWithDI extends BaseComponentTest {

    public WindowTestWithDI(){
        System.out.println();
    }
    ...
    @Test
    void gamescene_start(FxRobot robot, @Spy Spaceship spaceship) {

        hacker.spyFor(GameObjectFactory.class);
        ...
        when(gameObjectFactory.create()).thenReturn(gameObjects);
    ...
    @Test
    void gamescene_start2(FxRobot robot, @Spy Spaceship spaceship) {
