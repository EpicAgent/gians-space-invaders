...
public class QuestionGenerator {
     ...
     */
    public static Question[] generateQuestions(int numberOfQuestionsToGenerate, Difficulty difficulty) {
        String sURL = BASE_API_URL + "?amount=" + numberOfQuestionsToGenerate + "&difficulty=" + difficulty.name().toLowerCase();
